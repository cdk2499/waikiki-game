...
A mobile surf game built for Honolulu · Oʻahu.
...
Purely static HTML — no build step, no dependencies (besides a Google Fonts CDN call).

- **Vercel:** Import the repo, it deploys automatically.
- **GitHub Pages:** Enable Pages on the `main` branch, set root as source.
